...
export const MagicWandIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="m3 14 1.4-1.4a.5.5 0 0 1 .7 0L7 15l-4 4-1.4-1.4a.5.5 0 0 1 0-.7Z"></path>
    <path d="m17 3 4 4-1.4 1.4a.5.5 0 0 1-.7 0L17 6l-4 4 1.4 1.4a.5.5 0 0 1 0 .7L12 17l4-4-1.4-1.4a.5.5 0 0 1 0-.7Z"></path>
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className = "w-16 h-16" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 3L14.34 8.66L20 11L14.34 13.34L12 19L9.66 13.34L4 11L9.66 8.66L12 3Z"/>
        <path d="M3 21L4.34 18.66L7 17L4.34 15.34L3 13L1.66 15.34L-1 17L1.66 18.66L3 21Z"/>
        <path d="M17 7L18.34 4.66L21 3L18.34 1.34L17 -1L15.66 1.34L13 3L15.66 4.66L17 7Z"/>
    </svg>
);
